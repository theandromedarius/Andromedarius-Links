...
const links = [
  {
    ...
    image: icon,
    links: [
      { name: "Coordinates HUD", url: "/download/coordinates-hud", variant: "mc-secondary-button", },
      { name: "Durability Ping!", url: "/download/durability-ping", variant: "mc-secondary-button", },
      { name: "Day & Entity Counter", url: "/download/day-and-entity-counter", variant: "mc-secondary-button", },
      { name: "Biome Check", url: "/download/biome-check", variant: "mc-primary-button", },
      { name: "Trade Unlocker", url: "/download/trade-unlocker", variant: "mc-destructive-button", },
      { name: "Visualize Enchanted Book", url: "/download/visualize-enchanted-book", variant: "mc-realms-button", },
      { name: "Circular Hotbar", url: "/download/circular-hotbar", variant: "mc-informative-button", },
